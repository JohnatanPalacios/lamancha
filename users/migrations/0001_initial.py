    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('favoriteGenres', multiselectfield.db.fields.MultiSelectField(choices=[('dramatico', 'Dramático'), ('narrativo', 'Narrativo'), ('lirico', 'Lírico')], max_length=26, verbose_name='Preferencias literarias')),
